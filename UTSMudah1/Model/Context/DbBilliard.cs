...
namespace UTSMudah1.Model.Context
{
    public class DbBilliard : IDisposable
    {
        ...
        // Method ini digunakan untuk menghapus objek koneksi dari memory ketik sudah tidak digunakan
        public void Dispose()
        {
            if (_conn != null)
            {
